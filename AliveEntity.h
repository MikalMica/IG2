...
class AliveEntity : public IG2Object
{
	protected:
		...
		float speed;
	public:
		AliveEntity(Vector3 pos, Ogre::SceneNode* node, Ogre::SceneManager* mSM, string mesh, float sp = 500.0f) : IG2Object(pos, node, mSM, mesh), direction(0, 0), direction_buffer(0,0), speed(sp)
		{}
